...
class ConfigLoader:
    ...
    def read_config(self, model_type: Type[T]) -> T:
        ...
        parsed yaml file. This method will not read the yml config file from disk each time this function is invoked.
        Rather, the yaml file will be parsed and cached when this loader is first instantiated and the cache
        ...
        Once a particular model_type has been instantiated once it will be cached and the cached instance will
        be returned on subsequent invocations.
        ...
        :return: A populated instance of model_type.
        """
