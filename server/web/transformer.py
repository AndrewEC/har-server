...
from server.rewrite.response import with_response_rewriter, ResponseRewriter
...
class ResponseTransformer:
    ...
    def map_har_response_to_fastapi_response(self, response: HarEntryResponse) -> Response:
